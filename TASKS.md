...
| 1 — Data modeling | 6 | 3 | 🟡 In progress |
| 2 — API design | 6 | 0 | ☐ |
| 3 — Auth & security | 7 | 0 | ☐ |
| 4 — Caching (Redis) | 5 | 0 | ☐ |
| 5 — Concurrency | 6 | 0 | ☐ |
...
_Last updated: Task 1.3 complete — Course/Module/Lesson (JSONB content) + Enrollment + progress join tables (composite-PK) added to the schema._
