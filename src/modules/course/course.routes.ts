...
courseRouter.get('/', cacheControl(60), validate({ query: paginationQuery }), courseController.listCourses);
courseRouter.get('/:slug', cacheControl(300), validate({ params: courseSlugParams }), courseController.getCourse);
